...
const SharedWithMeBody = () => {
    ...
    const { files,fetchFilesSharedWithMe } = filecontext;

    const navigate = useNavigate();
    const foldercontext = useContext(folderContext);

    const { folders, fetchFoldersSharedWithMe } = foldercontext;
    ...
    useEffect(() => {
        fetchFilesSharedWithMe(query);
        fetchFoldersSharedWithMe(query);
...
export default SharedWithMeBody
...
function ResponsiveDrawer(props) {
  ...
  const drawer = (
    <div>
      <Toolbar sx={{ display: 'flex',justifyContent: 'center',alignItems: 'center' }}><Button
      variant="contained" 
      onClick={()=>setDialogOpen(true)}
      >Create folder</Button></Toolbar>

      <Divider />
      <List>
        {['My folders', 'Shared with me', 'Starred', 'Bin'].map((text, index) => (

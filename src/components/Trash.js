...
const Trash = () => {
    ...
    const { files, fetchFilesMovedToBin } = filecontext;
    ...
    useEffect(() => {
        fetchFilesMovedToBin(query);
        fetchFoldersMovedToBin(query);
        ...
        >
            ...
            <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
                ...
                <Grid container spacing={2} sx={{ display: "flex", justifyContent: { xs: "center", lg: "start" }, alignItems: 'center', my: "0.5rem" }}>
                    ...
                    <FolderMenu open={openfoldermenu} anchorEl={anchorElfolder} setAnchorEl={setAnchorElfolder} folder={contextFolder} reload={reload} setReload={setReload} isTrash={true} />
